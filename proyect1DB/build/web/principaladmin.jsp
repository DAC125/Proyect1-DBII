            ...
            <div class="row">
                <div class="col-12">
                    <div id="header">
                        ...
                        <div class="boton col-sm-6">     
                        <button class="btn btn-secondary" type="submit" name="accion" value="componentesadmin">Componentes</button>
                        </div> 
                    </div>
                </div>
            </div>
            ...
            <div class="content col-sm-10 col-sm-offset-1">
                <div class="row">
                    ...
                    <form  class="botones" action="controlador" method="POST">
                        ...
                        <div class="boton col-sm-3">
                        <button class="btn btn-secondary" type="submit" name="accion" value="tecladosadmin">Teclados</button>
                        </div> 
                        <div class="boton col-sm-3">
                        <button class="btn btn-secondary" type="submit" name="accion" value="mousesadmin">Mouses</button>
                        </div> 
                        <div class="boton col-sm-3">
                        <button class="btn btn-secondary" type="submit" name="accion" value="computadorasadmin">Computadoras</button>
                        </div> 
                    </form>
